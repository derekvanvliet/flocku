...
namespace Love_and_Hate
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        public Vector2 GetCurrentPointOfInterest()
        {
            return mCurrentPointOfInterest;
        }

        private void GetNewPointOfInterest()
        {
            Random random = new Random((int)DateTime.Now.Ticks);
            mCurrentPointOfInterest.X = random.Next(0, Config.Instance.GetAsInt("ScreenWidth"));
            mCurrentPointOfInterest.Y = random.Next(0, Config.Instance.GetAsInt("ScreenHeight"));
